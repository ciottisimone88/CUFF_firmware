...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DefSi=0, Direction=0, FifoSize=4, InterruptSource=2, Length=18, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, UseInputFifo=false, UseInterrupt=true, UseOutputFifo=true, UseShiftIn=true, UseShiftOut=false, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SHIFTREG_ENC_2, CY_INSTANCE_SHORT_NAME=SHIFTREG_ENC_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=SHIFTREG_ENC_2, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DefSi=0, Direction=0, FifoSize=4, InterruptSource=2, Length=18, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, UseInputFifo=false, UseInterrupt=true, UseOutputFifo=true, UseShiftIn=true, UseShiftOut=false, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SHIFTREG_ENC_3, CY_INSTANCE_SHORT_NAME=SHIFTREG_ENC_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=SHIFTREG_ENC_3, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DefSi=0, Direction=0, FifoSize=4, InterruptSource=2, Length=18, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, UseInputFifo=false, UseInterrupt=true, UseOutputFifo=true, UseShiftIn=true, UseShiftOut=false, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SHIFTREG_ENC_4, CY_INSTANCE_SHORT_NAME=SHIFTREG_ENC_4, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=SHIFTREG_ENC_4, )
...
module top ;
    ...
    assign Net_3390 = Net_3086 & Net_3545;
    ...
    assign Net_3388 = Net_3474 & Net_3096;
	...
	wire [0:0] tmpOE__Signal_3_C_net;
	wire [0:0] tmpIO_0__Signal_3_C_net;
	wire [0:0] tmpINTERRUPT_0__Signal_3_C_net;
	electrical [0:0] tmpSIOVREF__Signal_3_C_net;

	cy_psoc3_pins_v1_10
		#(.id("83854415-373b-4d18-90a9-de80917a9bb7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_3_C
		 (.oe(tmpOE__Signal_3_C_net),
		  .y({1'b0}),
		  .fb({Net_1349}),
		  .io({tmpIO_0__Signal_3_C_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_3_C_net),
		  .interrupt({tmpINTERRUPT_0__Signal_3_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_3_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_1287 = Net_1272 | Net_1313;
    ...
    assign Net_1352 = ~B_CLOCK_SHIFTREG;

    ShiftReg_v2_30_5 SHIFTREG_ENC_3 (
        .shift_in(Net_1349),
        .load(1'b0),
        .store(B_ENC_CSN),
        .clock(Net_1352),
    ...
    defparam SHIFTREG_ENC_3.Length = 18;
	...
	wire [0:0] tmpOE__Signal_3_B_net;
	wire [0:0] tmpFB_0__Signal_3_B_net;
	wire [0:0] tmpIO_0__Signal_3_B_net;
	wire [0:0] tmpINTERRUPT_0__Signal_3_B_net;
	electrical [0:0] tmpSIOVREF__Signal_3_B_net;

	cy_psoc3_pins_v1_10
		#(.id("df62917f-da37-42e1-ad44-cf3914d1e3cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_3_B
		 (.oe(tmpOE__Signal_3_B_net),
		  .y({B_CLOCK_SHIFTREG}),
		  .fb({tmpFB_0__Signal_3_B_net[0:0]}),
		  .io({tmpIO_0__Signal_3_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_3_B_net),
		  .interrupt({tmpINTERRUPT_0__Signal_3_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_3_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    ShiftReg_v2_30_6 SHIFTREG_ENC_4 (
        .shift_in(Net_1617),
        .load(1'b0),
        .store(B_ENC_CSN),
        .clock(Net_1620),
    ...
    defparam SHIFTREG_ENC_4.Length = 18;

	wire [0:0] tmpOE__Signal_4_B_net;
	wire [0:0] tmpFB_0__Signal_4_B_net;
	wire [0:0] tmpIO_0__Signal_4_B_net;
	wire [0:0] tmpINTERRUPT_0__Signal_4_B_net;
	electrical [0:0] tmpSIOVREF__Signal_4_B_net;

	cy_psoc3_pins_v1_10
		#(.id("0aa71f5d-dc9c-479f-97db-8f13edf8d170"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_4_B
		 (.oe(tmpOE__Signal_4_B_net),
		  .y({B_CLOCK_SHIFTREG}),
		  .fb({tmpFB_0__Signal_4_B_net[0:0]}),
		  .io({tmpIO_0__Signal_4_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_4_B_net),
		  .interrupt({tmpINTERRUPT_0__Signal_4_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_4_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Signal_4_C_net;
	wire [0:0] tmpIO_0__Signal_4_C_net;
	wire [0:0] tmpINTERRUPT_0__Signal_4_C_net;
	electrical [0:0] tmpSIOVREF__Signal_4_C_net;

	cy_psoc3_pins_v1_10
		#(.id("748d89e0-be64-4f1e-b545-d4f2c33ddcad"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_4_C
		 (.oe(tmpOE__Signal_4_C_net),
		  .y({1'b0}),
		  .fb({Net_1617}),
		  .io({tmpIO_0__Signal_4_C_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_4_C_net),
		  .interrupt({tmpINTERRUPT_0__Signal_4_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_4_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_1620 = ~B_CLOCK_SHIFTREG;

	wire [0:0] tmpOE__Signal_4_A_net;
	wire [0:0] tmpFB_0__Signal_4_A_net;
	wire [0:0] tmpIO_0__Signal_4_A_net;
	wire [0:0] tmpINTERRUPT_0__Signal_4_A_net;
	electrical [0:0] tmpSIOVREF__Signal_4_A_net;

	cy_psoc3_pins_v1_10
		#(.id("d4ebbb4a-9361-4f60-ab03-0a342935d673"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_4_A
		 (.oe(tmpOE__Signal_4_A_net),
		  .y({B_ENC_CSN}),
		  .fb({tmpFB_0__Signal_4_A_net[0:0]}),
		  .io({tmpIO_0__Signal_4_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_4_A_net),
		  .interrupt({tmpINTERRUPT_0__Signal_4_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_4_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Signal_3_A_net;
	wire [0:0] tmpFB_0__Signal_3_A_net;
	wire [0:0] tmpIO_0__Signal_3_A_net;
	wire [0:0] tmpINTERRUPT_0__Signal_3_A_net;
	electrical [0:0] tmpSIOVREF__Signal_3_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f0b79b7e-ffd8-4fbd-a0a3-b2c7efee6a22"),
		  ...
		  .input_buffer_sel(2'b00))
		Signal_3_A
		 (.oe(tmpOE__Signal_3_A_net),
		  .y({B_ENC_CSN}),
		  .fb({tmpFB_0__Signal_3_A_net[0:0]}),
		  .io({tmpIO_0__Signal_3_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Signal_3_A_net),
		  .interrupt({tmpINTERRUPT_0__Signal_3_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Signal_3_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_3389 = Net_3086 & Net_3076;
    ...
    assign Net_3387 = Net_3474 & Net_3099;
    ...
    assign Net_5513 = Net_4627 | Net_5526;
    ...
    assign Net_5526 = Net_5503 & Net_5205;
    ...
    assign Net_6183 = Net_6357 | Net_6322;
